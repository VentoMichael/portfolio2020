 ...
 * @example
 * ```js
 * const path1 = getPath( 'http://ventomichael.site/this/is/a/test?query=true' ); // 'this/is/a/test'
 ...
 * @example
 * ```js
 * const queryString1 = getQueryString( 'http://ventomichael.site/this/is/a/test?query=true#fragment' ); // 'query=true'
 ...
 * @example
 * ```js
 * const fragment1 = getFragment( 'http://ventomichael.site/this/is/a/test?query=true#fragment' ); // '#fragment'
